...
def test_chance_scores_sum_of_all_dice():
    ...
    assert 14 == Yatzy.chance(3, 3, 1, 6, 1)
...
def test_threes():
    ...
    assert 0 == Yatzy.threes(1, 4, 2, 5, 6)
...
def test_fours_test():
    ...
    assert 0 == Yatzy(5, 5, 5, 5, 5).fours()


def test_fives():
    assert 0 == Yatzy(4, 4, 4, 6, 6).fives()
...
def test_one_pair():
    ...
    assert 8 == Yatzy.score_pair(3, 4, 3, 4, 3)
    assert 0 == Yatzy.score_pair(1, 3, 3, 3, 4)
    assert 0 == Yatzy.score_pair(1, 3, 3, 3, 3)


def test_two_Pair():
    assert 8 == Yatzy.two_pair(1, 1, 2, 3, 3)
    assert 16 == Yatzy.two_pair(3, 3, 5, 4, 5)
    assert 0 == Yatzy.two_pair(3, 3, 6, 6, 6)
    assert 0 == Yatzy.two_pair(3, 3, 6, 5, 4)
    assert 0 == Yatzy.two_pair(3, 3, 4, 4, 4)
