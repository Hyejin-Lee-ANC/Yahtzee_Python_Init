...
class Rules(object):
    ...
    def __init__(self):
        self.rules_map = {
            ...
            7: self.pair,
            8: self.two_pairs,
            9: self.three_of_a_kind,
            10: self.four_of_a_kind,
            11: self.full_house,
            12: self.small_straight,
            13: self.large_straight,
            14: self.yahtzee,
            15: self.chance,
        }
    ...
    def pair(self, hand):
        ...
        for i in hand.get_hand():
            if hand.get_hand().count(i) == 2 and pair_value < i:
                pair_value = i
        return pair_value * 2
    ...
    def two_pairs(self, hand):
        pair_value = []
        for i in hand.get_hand():
            if hand.get_hand().count(i) == 2 and not pair_value.__contains__(i):
                pair_value.append(i)

        if len(pair_value) < 2:
            return 0

        return sum(pair_value) * 2
